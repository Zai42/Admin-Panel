  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="{{route('updateController',['id'=>$employee->emp_id])}}" class="btn btn-primary">Update</a></td>
          </tr>
      ...
      <div class="text-center">
        <a href="{{route('add_employee')}}" class="btn btn-success mb-2">Enter new employee</a>
        <br>
